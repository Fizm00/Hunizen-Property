    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      <main className="flex-grow w-full max-w-[1680px] mx-auto px-4 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Left Column: Sidebar Card Skeleton */}
          <div className="lg:col-span-4 w-full flex flex-col gap-6">
            ...
            {/* Sidebar Navigation Card Skeleton */}
            ...
            {/* Upgrade Landlord Promo Card Skeleton */}
