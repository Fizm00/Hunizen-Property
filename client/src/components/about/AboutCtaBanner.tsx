  ...
  return (
    <section className="w-full bg-white py-16 px-6 md:px-12 flex justify-center">
      <motion.div 
        ...
        className="w-full max-w-7xl rounded-4xl md:rounded-[3rem] overflow-hidden relative shadow-xl bg-brand-green border border-brand-green-accent/40 flex flex-col md:flex-row justify-between items-center gap-8 px-8 md:px-16 py-14 md:py-16 text-white"
      >
        <div className="absolute right-0 top-0 bottom-0 w-full md:w-1/2 h-full z-0 pointer-events-none overflow-hidden select-none bg-brand-green-accent">
          ...
          />
          <div className="absolute inset-0 bg-linear-to-r from-brand-green via-brand-green/30 to-transparent" />
          <div className="absolute inset-0 bg-linear-to-t from-brand-green via-transparent to-transparent md:hidden" />
        </div>
